...
如果您不想从零开始跑爬虫（耗时较长），可以直接前往本仓库的 **[Releases](https://github.com/sublatesublate-design/legal-database/releases)** 页面下载预先构建好的 `legal_database.db` 文件（约 426MB），并将其放入项目根目录下即可立即使用。
